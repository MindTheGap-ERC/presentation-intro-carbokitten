...
*Quantifying the completeness of the stratigraphic record and its role in reconstructing the tempo and mode of evolution* - funded by the EU's European Research Council

Focus: how does stratigraphic architecture affect the record of evolution and how can we correct for the missing information using sedimentology and stratigraphy?
...
[[deps.CarboKitten]]
deps = ["CSV", "CategoricalArrays", "DataFrames", "DelimitedFiles", "GLMakie", "GeometryBasics", "HDF5", "Interpolations", "LinearAlgebra", "Logging", "LoggingExtras", "ModuleMixins", "Pkg", "ProgressLogging", "QuadGK", "Random", "StaticArrays", "TOML", "TerminalLoggers", "Unitful"]
git-tree-sha1 = "fb12b06f1a6f234aa0c86d7f1d7bc37329a5b18f"
